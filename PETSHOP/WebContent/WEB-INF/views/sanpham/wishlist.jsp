								...
								<table class="table">
									...
									<c:forEach var="ds" items="${list}">
										<tbody>
											...
											<tr>
												<td class="product_remove"><a href="view/removeWishlist/${ds.maSP}.htm"> <i
														class="pe-7s-close" data-tippy="Remove"
														data-tippy-inertia="true"
														data-tippy-animation="shift-away" data-tippy-delay="50"
														data-tippy-arrow="true" data-tippy-theme="sharpborder"></i>
												</a></td>
												<td class="product-img"><a href="view/single/${ds.maSP}.htm"> <img width="50" height="90"
														src="<c:url value = '${ds.hinhAnh}'/>"
														alt="Wishlist Thumbnail">
												</a></td>
												<td class="product-name"><a href="view/single/${ds.maSP}.htm">${ds.tenSP}</a></td>
												<td class="product-price"><span class="amount"><fmt:formatNumber type="currency" currencySymbol="VND" value="${ds.gia}"/></span></td>
												<td class="product-stock-status"><span class="in-stock">${ds.tinhTrang?'Còn hàng':'Hết hàng'}</span></td>
												<td class="cart_btn"><a href="view/cart2/${ds.maSP}.htm">add to cart</a></td>
											</tr>
