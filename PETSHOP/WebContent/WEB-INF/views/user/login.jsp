                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 pt-5 pt-lg-0">
                            <form:form action="user/login.htm" modelAttribute="taikhoan">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <form:input path="tenDangNhap" type="text" placeholder="Tên đăng nhập"></form:input>
                                            <span style="color: red">${LoiDinhDangTenDangNhap}</span>
                                        </div>
                                        <div class="col-lg-12">
                                            <label>Mật khẩu</label>
                                            <form:input path="matKhau" type="password" placeholder="Mật khẩu"></form:input>
                                        ...
                                        <div class="col-lg-12 pt-5">
                                            <button class="btn btn-custom-size lg-size btn-pronia-primary">Đăng nhập</button>
                                        </div>
                                    </div>
                                </div>
                            </form:form>
