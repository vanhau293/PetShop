                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 pt-5 pt-lg-0">
                            <form:form action="user/quenmatkhau.htm" method="post">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label>Email</label>
                                            <input name="email" type="text" placeholder="Nhập email để lấy lại mật khẩu"></input>
                                            <span style="color: red">${LoiDinhDangEmail}</span>
                                        </div>

                                        <div class="col-lg-12 pt-5">
                                            <button class="btn btn-custom-size lg-size btn-pronia-primary">Xác nhận</button>
                                        </div>
                                    </div>
                                </div>
                            </form:form>
